            ...
            <div style = {style}>
                <Grid.Row>
                        <Grid.Column fluid width = {16}>
                            <div style = {{zIndex: '100', paddingLeft: '1%', paddingTop: "2%", position: 'fixed', marginBottom: '3%'}}>
                ...
                <Grid centered>
                    <Grid.Row>
                        ...
                        <h1 style = {{marginTop: '2%', color: 'grey', fontSize: '3rem'}}>New Post</h1>
                    </Grid.Row>
                    <Grid.Column width = {13}>
                    <Form error onSubmit = {this.onSumbit}>
                            
                            <Form.Input required name = "title" value = {this.state.title} onChange = {this.onChange} label = "Title" placeholder = "Post Title"></Form.Input>
                                ...
                                <Form.Field
                                  ...
                                  name = "reference"
                                />
                                <TextArea label = "Content" placeholder='Post Content' style={{ minHeight: 150 }} name = "textarea" onChange = {this.onChange} />
                                <br></br>
                                <br></br>
                                <br></br>
    
                                <Button primary floated = "right"> <Icon name = 'send'></Icon>Post</Button>
