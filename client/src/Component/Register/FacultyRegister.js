...
import { Grid, Image, Header, Form, Button, Select, Message, Icon } from 'semantic-ui-react'
        ...
        <Grid.Column>
          <div style={style}>
            <Header
              ...
              color="grey"
              textAlign="center"
              content="Register SVNIT Faculty"
            ></Header>
            {this.state.alreadyExist ? (
              <Message error>
                <Message.Header>Account Alredy exist</Message.Header>
              </Message>
            ) : (
              <span></span>
            )}
