    ...
    return (
      <Router>
        <Switch>
          ...
          <PrivateRoute exact path="/home" component={Feed}></PrivateRoute>
          <PrivateRoute exact path="/new-post" component={NewPost}></PrivateRoute>
          <PrivateRoute exact path="/all-user" component={UserList}></PrivateRoute>
          <PrivateRoute exact path="/profile" component={Profile}></PrivateRoute>
          <PrivateRoute exact path="/my-post" component={PostByMe}></PrivateRoute>
        </Switch>
      </Router>
    )
  }
